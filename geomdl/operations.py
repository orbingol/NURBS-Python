...
def refine_knotvector(obj, param, **kwargs):
    ...
    **Example**: Let the degree be 2 and the knot vector to be refined be ``[0, 2, 4]`` with the superfluous knots
    from the start and end removed. Knot vectors with the changing ``density (d)`` value will be:
