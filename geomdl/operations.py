...
import copy
import warnings
from . import abstract, helpers, evaluators, linalg, compatibility
...
def refine_knotvector(obj, param, **kwargs):
    ...
    * ``d = 2``, knot vector ``[0, 1, 1, 2, 2, 3, 3, 4]``
    * ``d = 3``, knot vector ``[0, 0.5, 0.5, 1, 1, 1.5, 1.5, 2, 2, 2.5, 2.5, 3, 3, 3.5, 3.5, 4]``
