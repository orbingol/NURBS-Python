    ...
    * :py:attr:`sample_size`
    ...
    def delta(self, value):
        if self._pdim == 1 and isinstance(value, (int, float)):
            ...
            if isinstance(value, abc.GeomdlSequence):
    ...
    * :py:attr:`sample_size`
    ...
    def render(self, **kwargs):
        ...
        * ``reset_names``: resets the name of the curves inside the container. *Default: False*
        ...
        if isinstance(cpcolor, abc.GeomdlSequence):
        ...
        if isinstance(evalcolor, abc.GeomdlSequence):
...
class SurfaceContainer(AbstractContainer):
    ...
    * :py:attr:`faces`
    ...
    def render(self, **kwargs):
        ...
        if not isinstance(surf_cmaps, abc.GeomdlSequence):
