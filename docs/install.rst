...
A collection of Docker containers is provided on `Docker Hub <https://hub.docker.com/r/orbingol/geomdl/>`_
...
.. code-block:: console
    ...
    $ docker pull orbingol/geomdl:py35

On the `Docker Repository <https://hub.docker.com/r/orbingol/geomdl/>`_ page, you can find containers tagged for
...
.. code-block:: console
    ...
    $ docker run --rm -it --name nurbs -p 8000:8000 orbingol/geomdl:py35
